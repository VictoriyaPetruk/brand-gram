...
import AwsStaticReplica from "./AwsStaticReplica";
      ...
      <div className='flex-1 flex flex-col justify-center items-center bg-gray-100'>
        ...
        {diagramVisible && (
          <div className='mt-4 mb-2 flex items-center gap-3'>
            <a
               href="https://eu-central-1.console.aws.amazon.com/lambda/home?region=eu-central-1#/functions/CloudBlocks?newFunction=true&tab=code"
              target='_blank'
