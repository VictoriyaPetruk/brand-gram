...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative w-64 cursor-pointer overflow-hidden rounded-3xl border border-border/60 bg-card p-4 shadow-soft transition-shadow hover:shadow-md",
    ...
    >
      <div className="flex flex-row items-center gap-2">
        ...
        <div className="flex flex-col">
          <figcaption className="bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-500 bg-clip-text text-sm font-medium text-transparent">
            {name}
          </figcaption>
